...
<html>
	...
	<section class="content">
		...
		<c:if test="${currentPage > 1}">
			<a href="${pageContext.request.contextPath}/tia102g1/staff/staff.do?action=getAll&page=1">至第一頁</a>&nbsp;
		</c:if>
		<c:if test="${currentPage - 1 != 0}">
			<a href="${pageContext.request.contextPath}/tia102g1/staff/staff.do?action=getAll&page=${currentPage - 1}">上一頁</a>&nbsp;
		</c:if>
		<c:if test="${currentPage + 1 <= staffPageQty}">
			<a href="${pageContext.request.contextPath}/tia102g1/staff/staff.do?action=getAll&page=${currentPage + 1}">下一頁</a>&nbsp;
		</c:if>
		<c:if test="${currentPage != staffPageQty}">
			<a href="${pageContext.request.contextPath}/tia102g1/staff/staff.do?action=getAll&page=${staffPageQty}">至最後一頁</a>&nbsp;
		</c:if>
